...
export function fixableVerificationVerdict(result: VerificationResult): boolean {
...
export function buildPostExecutionConvRequest(
  request: GoalRequest,
  runId: string,
...
export function buildPostExecutionEvidencePacket(
  request: GoalRequest,
  runId: string,
  steps: GoalStep[],
  receiptsPath: string,
...
export function buildPostConvergenceEvidencePacket(
  request: GoalRequest,
  runId: string,
  steps: GoalStep[],
  receiptsPath: string,
