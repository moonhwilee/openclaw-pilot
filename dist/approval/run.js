...
const requiredArtifactNames = ["goal.json", "plan.md", "events.jsonl", "final.md"];
...
function isPilotReceiptsDashboardRequest(request) {
...
function isRunnerBackedGoalRequest(request) {
    const normalized = request.toLowerCase();
